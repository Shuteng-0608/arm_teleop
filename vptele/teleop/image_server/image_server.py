...
if __name__ == "__main__":
    ...
    config = {
        ...
        'head_camera_id_numbers': [realsense_devices[0]],  # 使用检测到的第一个RealSense相机
    }
    
    # 如果有多个RealSense相机，可以设置第二个为腕部相机
    # if len(realsense_devices) > 1:
    #     config.update({
    #         'wrist_camera_type': 'realsense',
    #         'wrist_camera_image_shape': [480, 640],  # Wrist camera resolution
    #         'wrist_camera_id_numbers': realsense_devices[1:],  # 使用剩余的RealSense相机
    #     })
