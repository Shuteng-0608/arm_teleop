...
This module maps canonical 27x3 Vision Pro hand keypoints into MH6
low-dimensional hand intentions. It intentionally contains no Vision Pro
streaming, ROS node startup, Modbus, or hardware control code.
"""
...
class MH6HandMapper:
    ...
    def calibrate_open(self, samples: List[np.ndarray]) -> None:
        ...
        for sample in samples:
            ...
            for finger in LONG_FINGERS:
                opposition_distances[finger].append(
    ...
    def compute_opposition(self, points: np.ndarray) -> Dict[str, float]:
        ...
        for finger, key in (
            ...
            opposition[key] = threshold_strength(
                raw_strength,
                self.calibration.opposition_threshold,
            )
        return opposition
